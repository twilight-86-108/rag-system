...
from llm_integration import LLMManager, create_rag_prompt, format_context_from_docs
...
class RetrieverConfig:
    ...
    Attributes:
        search_type: 検索タイプ（'similarrity', 'mmr'）
        k: 取得する文書数
...
class RAGPipeline:
    ...
    def __init__(
        ...
        logger.info("RAGPipeline initialized successfuly.")
    ...
    def from_existing_vectorstore(
        ...
        logger.info("RAGPipeline creted successfuly")
    ...
    def from_documents(
        ...
        logger.info("RAGPipeline created from documents successfuly")
